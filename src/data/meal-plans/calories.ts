...
export const caloriePages: MealPlanPageData[] = [
  {
    ...
    intro:
      "Eating 1,200 calories a day doesn't have to mean feeling hungry all the time. The trick is choosing foods that pack maximum nutrition into every bite — high-fiber vegetables, lean proteins, and healthy fats that keep you satisfied for hours. We build you a fresh 1200-calorie plan each week with meals that are flavorful, filling, and designed so you never feel like you're white-knuckling through a diet.",
    valueProps: [
      {
        heading: "Every calorie earns its place",
        description:
          "At 1,200 calories, there's no room for empty filler. Every meal is built around nutrient-dense ingredients — leafy greens, lean proteins, eggs, and whole grains — so you hit your vitamin and mineral targets despite the low intake.",
      },
      {
        heading: "Satiety-first design",
        description:
          "We prioritize high-volume, low-calorie foods like zucchini, cauliflower, berries, and broth-based soups that fill your plate and your stomach without blowing your budget.",
      },
      {
        heading: "Not a crash diet",
        description:
          "This is a structured, sustainable approach — not starvation. Meals include adequate protein (80g+ daily) to preserve muscle mass, and enough healthy fats to keep hormones and energy in check.",
      },
    ],
    sampleMeals: [
      {
      ...
      },
      {
        ...
        mealType: "lunch",
        description:
          "Ground chicken sauteed with water chestnuts, ginger, and tamari, served in crisp butter lettuce cups with shredded carrots and a squeeze of lime.",
        prepTime: "15 min",
      ...
      },
      {
        ...
        mealType: "dinner",
        description:
          "Baked cod fillet seasoned with lemon and herbs alongside roasted asparagus and grape tomatoes. Light, satisfying, and under 320 calories.",
        prepTime: "25 min",
      ...
      },
      {
        ...
        mealType: "dinner",
        description:
          "Garlic shrimp tossed with spiralized zucchini noodles in a light white wine and lemon butter sauce with red pepper flakes.",
        prepTime: "20 min",
        tags: ["low-carb", "quick"],
      },
      {
    ...
    faqs: [
      {
        question: "Is 1200 calories a day safe?",
        answer:
          "For many small-framed or sedentary adults, 1,200 calories can be an appropriate target for weight loss when the meals are nutrient-dense. However, it's not suitable for everyone — taller individuals, active people, and those with certain medical conditions may need more. We recommend consulting your doctor before committing to a 1,200-calorie plan long-term. Our plans prioritize protein, fiber, and micronutrients to keep you nourished even at lower intake.",
      },
      {
        question: "How do I avoid feeling hungry on 1200 calories?",
        answer:
          "The key is volume and satiety. Our plans emphasize high-volume foods like leafy greens, cruciferous vegetables, and broth-based soups that physically fill your stomach. We also include adequate protein at every meal (which slows digestion) and strategic healthy fats to keep you satisfied between meals. Drinking enough water and spacing meals 3-4 hours apart also helps tremendously.",
      },
      {
        question: "Will I lose muscle on a 1200 calorie diet?",
        answer:
          "Muscle loss is a real concern at any calorie deficit, which is why our 1,200-calorie plans include 80-100g of protein per day. Combined with basic resistance exercise, this level of protein intake helps preserve lean muscle mass while you lose fat. We spread protein across all meals rather than loading it into one.",
      },
      {
        question: "Can I exercise on 1200 calories?",
        answer:
          "Light to moderate exercise like walking, yoga, or light strength training is generally fine. However, intense cardio or heavy lifting may require more fuel. If you're regularly exercising hard, consider our 1,500 or 1,800 calorie plans instead. Listen to your body — if you feel dizzy or exhausted during workouts, it's a sign you need more calories.",
      },
      {
        question: "How much weight can I lose on 1200 calories a day?",
        answer:
          "Results vary based on your starting weight, activity level, and metabolism. Most people see 1-2 pounds per week on a 1,200-calorie plan, which is a healthy and sustainable rate. Faster loss is possible early on (often water weight), but steady progress is what leads to lasting results. Our weekly plans keep meals varied so you can stick with it long enough to see real change.",
      },
    ],
    relatedSlugs: [
  ...
  },
  {
    ...
    intro:
      "1,500 calories hits the sweet spot for most people looking to lose weight without feeling miserable. It's enough to include real portions, diverse ingredients, and even the occasional treat — but still low enough to create a meaningful calorie deficit. We plan your week with balanced macros, plenty of flavor, and meals that take 30 minutes or less so the plan actually fits your life.",
    valueProps: [
      {
        heading: "The sustainable middle ground",
        description:
          "Not so low that you're counting every almond, not so high that the scale doesn't move. 1,500 calories gives most sedentary to lightly active adults a 500-750 calorie deficit — the range where consistent, lasting weight loss happens.",
      },
      {
        heading: "Balanced macros, not just low calories",
        description:
          "We don't just cut calories — we balance them. Each day includes roughly 40% carbs, 30% protein, and 30% fat so you have energy, preserve muscle, and stay satisfied without blood sugar crashes.",
      },
      {
        heading: "Room for real food",
        description:
          "At 1,500 calories you can still enjoy whole grain pasta, fruit, cheese, and even dark chocolate. Our plans use smart portions rather than elimination, so nothing feels off-limits.",
      },
    ],
    sampleMeals: [
      {
        ...
        mealType: "breakfast",
        description:
          "Rolled oats soaked in almond milk with chia seeds, topped with sliced banana, crushed walnuts, and a drizzle of honey. 340 calories with 12g protein and 6g fiber.",
        prepTime: "5 min",
      ...
      },
      {
        ...
        mealType: "lunch",
        description:
          "Farro tossed with cucumber, cherry tomatoes, kalamata olives, red onion, and crumbled feta with a lemon-oregano vinaigrette.",
        prepTime: "15 min",
      ...
      },
      {
        ...
        mealType: "dinner",
        description:
          "Boneless chicken thighs glazed with honey, garlic, and soy sauce, pan-seared and served with sauteed green beans and brown rice.",
        prepTime: "30 min",
        tags: ["high-protein", "one-pan"],
      },
      {
        ...
        mealType: "dinner",
        description:
          "Roasted sweet potato and seasoned black beans in corn tortillas with avocado crema, pickled red onion, and fresh cilantro.",
        prepTime: "30 min",
      ...
      },
      {
        ...
        mealType: "snack",
        description:
          "A lightly salted rice cake spread with natural peanut butter and topped with thin apple slices and a dash of cinnamon. 190 calories.",
        prepTime: "3 min",
        tags: ["quick", "no-cook"],
      },
    ],
    faqs: [
      {
        ...
        answer:
          "A 1,500-calorie plan works well for most sedentary to moderately active adults looking to lose weight. It's particularly effective for women with desk jobs and shorter men. If you're very active or have a physically demanding job, you may need 1,800-2,000 calories instead. As always, check with your doctor if you're unsure about the right target for your body.",
      },
      {
        question: "How long does it take to see results on 1500 calories?",
        answer:
          "Most people notice changes within 2-3 weeks. The first week often shows a larger drop (partly water weight), then you can expect a steady 1-1.5 pounds per week. Visible body composition changes typically appear around weeks 4-6. Consistency matters more than perfection — hitting your target most days is far better than alternating between 1,200 and 2,500.",
      },
      {
        question: "Can I eat out while following a 1500 calorie plan?",
        answer:
          "Absolutely. Restaurant meals tend to run 600-900 calories, so plan lighter meals around them. A light breakfast and protein-focused lunch can leave 600-700 calories for dinner out. Most restaurants now list calories on menus, and grilled proteins with vegetables are almost always a reliable option. Our plans are designed so you can swap one meal without derailing your whole day.",
      },
      {
        question: "Should I eat 1500 calories on days I exercise?",
        answer:
          "For moderate exercise (30-45 minute walks, light strength training), 1,500 calories is usually fine. For intense workouts — long runs, heavy lifting, HIIT sessions — you may want to add 200-300 calories on those days, preferably from protein and complex carbs. The goal is to fuel performance without eliminating your deficit entirely.",
      },
    ],
    relatedSlugs: [
