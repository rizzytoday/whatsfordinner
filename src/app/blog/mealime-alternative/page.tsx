  ...
  return (
    <>
      ...
      <div className="space-y-4 text-stone-600 leading-relaxed">
        ...
        <p>
          If you&apos;ve hit that wall &mdash; or you&apos;re just looking
          for something that feels less like browsing a recipe app and more
          like having a personal meal planner &mdash;{" "}
      ...
      <div className="space-y-4 text-stone-600 leading-relaxed">
        <p>
          ...
          years. It&apos;s known for its polished mobile experience &mdash;
        ...
        <p>
          ...
          dietary filters. If you want more options &mdash; things like
          low-carb, keto, or paleo filters &mdash; you&apos;ll need{" "}
      ...
      <div className="space-y-4 text-stone-600 leading-relaxed">
        <p>
          Credit where it&apos;s due &mdash; Mealime gets a lot of things
        ...
        <p>
          ...
          &mdash; it&apos;s what it <em>doesn&apos;t</em> do. And once you
      ...
      <div className="space-y-4 text-stone-600 leading-relaxed">
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody className="text-stone-600">
              <tr className="border-b border-stone-100">
                ...
                <td className="py-3 px-4">You pick from a catalog</td>
                <td className="py-3 pl-4">AI builds your plan automatically</td>
              </tr>
              <tr className="border-b border-stone-100">
              ...
              <tr>
                ...
                <td className="py-3 pl-4">Yes (full plan, no signup)</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <p>
          The fundamental difference comes down to this: Mealime is a recipe
          browser with filters. What&apos;s For Dinner is an AI that knows
          your preferences and creates a completely original{" "}
          <Link
          ...
          every single week. No two weeks are the same. No recycled recipes
      ...
      <div className="space-y-4 text-stone-600 leading-relaxed">
        ...
        <p>
          Your first personalized meal plan shows up immediately. Then a new
          one arrives in your inbox every week &mdash; no app to open, no
      ...
      <div className="space-y-4 text-stone-600 leading-relaxed">
        ...
        <p>
          ...
          &mdash; the AI creates new combinations every time.
        </p>
        ...
        <p>
          ...
          AI adjusts ingredients accordingly. If you&apos;re watching your
          spending, every recipe in your plan will respect that.
        </p>
        ...
        <p>
          ...
          <strong>full AI-generated meal plan</strong> with grocery list
          &mdash; no account creation, no credit card, no email required. You
