  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 py-24 sm:py-40 text-center">
        <h1 className="text-[1.6rem] sm:text-5xl md:text-6xl font-bold text-stone-900 tracking-tight leading-[1.1] whitespace-nowrap text-center -translate-x-1 sm:-translate-x-7">
